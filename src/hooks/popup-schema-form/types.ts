...
export type PopupSchemaFormRegisterProps<TModel extends Recordable> = Omit<PopupSchemaFormProps<TModel>, 'model' | 'schema' | 'visible'> & {
  'model': TModel
 ...
 */
export interface UsePopupSchemaFormReturn<TModel extends Recordable> {
  /**
