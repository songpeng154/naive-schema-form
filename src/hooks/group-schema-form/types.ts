 ...
 */
export type UseGroupSchemaFormOptions<TModel extends object = any> = WrapWithMaybeRef<Omit<GroupSchemaFormProps, 'model' | 'register' | 'schema'>> & {
  schema?: DefineGroupSchema<TModel>[]
}
 ...
 */
export type UseGroupSchemaFormArgs<TModel extends object = any>
 ...
 */
export interface UseGroupSchemaFormReturn<TModel extends object = any> {
  /**
